...
const form = useForm({
    numero: "",
    nombre: "",
    telefono: "", // 👈 Estado para el nuevo campo
    cantidad: "",
    concepto: "",
...
// ⚡ AHORA USA DIRECTAMENTE EL TELÉFONO GUARDADO EN EL RECIBO
const enviarPorWhatsapp = (recibo) => {
    ...
    // Limpiamos espacios, guiones o letras
    ...
    // Formateamos con prefijo +34 de España si no lo lleva
    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-6xl mx-auto p-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <h1 class="text-2xl font-bold text-gray-800">Historial de Recibos</h1>

                <div class="flex items-center gap-4">
                    <button
                        @click="exportarExcel"
                        type="button"
                        class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded-lg shadow text-sm transition-colors cursor-pointer"
                    >
            ...
            <!-- FORMULARIO DE REGISTRO DE RECIBOS -->
            <form
            ...
            >
                ...
                <div class="md:col-span-2 lg:col-span-3 flex justify-end">
                    <button
                        ...
                        class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-lg shadow transition-colors cursor-pointer text-sm"
                    >
                        Guardar Recibo
                    </button>
                </div>
